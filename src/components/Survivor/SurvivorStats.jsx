      ...
      <div className="box survivorStats">
        ...
        >
          <div className="statGroup">
            <Stats name={"Mov"} amount={this.state.movement} />
            <Stats name={"Acc"} amount={this.state.accuracy} />
            <Stats name={"Str"} amount={this.state.strength} />
            <Stats name={"Eva"} amount={this.state.evasion} />
            <Stats name={"Luck"} amount={this.state.luck} />
            <Stats name={"Spd"} amount={this.state.speed} />
          </div>
        </button>
