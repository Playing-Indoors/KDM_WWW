        ...
        <Modal isOpen={this.state.showModal} toggle={this.handleModal}>
          ...
          <ModalBody>
            ...
            <TabContent activeTab={this.state.activeTab}>
              ...
              <TabPane tabId="age1">Age 1</TabPane>
              <TabPane tabId="age2">Age 2</TabPane>
              <TabPane tabId="age3">Age 3</TabPane>
              <TabPane tabId="age4">Age 4</TabPane>
              <TabPane tabId="retire">retire</TabPane>
            </TabContent>
          </ModalBody>
          <ModalFooter>
            {this.renderConfirm()}
