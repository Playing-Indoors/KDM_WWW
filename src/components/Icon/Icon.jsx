...
icons.nav = {
  icon:
    '<g><path d="M1.75,40.74H39A1.75,1.75,0,0,0,40.74,39V1.75A1.75,1.75,0,0,0,39,0H1.75A1.75,1.75,0,0,0,0,1.75V39A1.75,1.75,0,0,0,1.75,40.74Zm35.49-3.5H29.87V3.5h7.36ZM3.5,3.5H26.37V37.24H3.5Z"/></g>',
  width: 40.74,
  height: 40.74
};
icons.help = {
  icon:
    '<g><path d="M17.6,35.2A17.6,17.6,0,1,1,35.2,17.6,17.62,17.62,0,0,1,17.6,35.2Zm0-32.73A15.13,15.13,0,1,0,32.73,17.6,15.14,15.14,0,0,0,17.6,2.48Z"/><path d="M17.46,21.55a1.24,1.24,0,0,1-1.24-1.24V17.56a1.24,1.24,0,0,1,1.24-1.24,2.34,2.34,0,1,0-2.16-3.25,1.24,1.24,0,1,1-2.28-1,4.81,4.81,0,1,1,5.67,6.53v1.67A1.24,1.24,0,0,1,17.46,21.55Z"/><circle cx="17.6" cy="25.11" r="1.44"/></g>',
  width: 35.2,
  height: 35.2
};
icons.settlement = {
  icon:
    '<g><rect y="20.77" width="8.14" height="8.14" rx="2" ry="2"/><rect y="10.33" width="8.14" height="8.14" rx="2" ry="2"/><rect width="8.14" height="8.14" rx="2" ry="2" /></g>',
  width: 8.14,
  height: 28.91
};
icons.faq = {
...
icons.menu = {
  icon:
    '<g><path d="M30.11,28.32h-28a2.16,2.16,0,1,1,0-4.31h28a2.16,2.16,0,1,1,0,4.31Z" /><path d="M30.11,16.49h-28a2.16,2.16,0,0,1,0-4.31h28a2.16,2.16,0,0,1,0,4.31Z" /><path d="M30.11,4.31h-28A2.16,2.16,0,0,1,2.16,0h28a2.16,2.16,0,0,1,0,4.31Z" /></g>',
  width: 32.27,
  height: 28.32
};
