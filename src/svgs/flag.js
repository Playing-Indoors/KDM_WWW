export function flag() {
  return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25.43 45.88" className="svg-flag">
			<title>flag</title>
				<rect x="2.36" y="3.38" width="12.79" height="20.19" fill="#fff" stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3"/>
				...
				<path d="M15,31.07a1.5,1.5,0,0,0,0-3H11.9a1.5,1.5,0,1,0,0,3Z" fill="#fff"/>
